...
public class ListaActivity extends AppCompatActivity
    ...
    private void carregarListaRecycler() {
        ...
        List<Veiculos> veiculos = dao.buscaVeiculos();

        VeiculoRecycleAdapter adapter = new VeiculoRecycleAdapter(this, veiculos);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Toast.makeText(getApplicationContext(), "TENHO QUE TERMNINAR", Toast.LENGTH_LONG).show();
        }
   ...
   /* @Override
    public void onCreateContextMenu(ContextMenu menu, View v, final ContextMenu.ContextMenuInfo menuInfo) {
        ...
        Veiculos veiculo = (Veiculos) recyclerList.getItemAtPosition(info.position);
